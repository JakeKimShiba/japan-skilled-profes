...
const guides = [
  {
    ...
    sections: [
      ...
      { title: "2025년 경영비자 요건 강화와 고도인재 비자의 가치", summary: "2025년 10월 16일부터 경영·관리 비자 요건이 대폭 강화되었습니다. 자본금 500만엔→3,000만엔, 상근직원 1명 필수, JLPT N2 필요, 전문가 사업계획 확인 의무화. 3년간 경과조치(~2028.10). 고도인재 비자(ハ)가 현실적 대안으로 부상." },
  ...
  },
  {
    ...
    description: "JLPT N1, N2, BJT가 고도인재 비자 포인트에 미치는 영향을 상세히 정리합니다. 일본어 능력 시험별 점수 차이, 시험 준비 전략, N2에서 N1 올리는 팁까지.",
    keywords: ["JLPT N1", "JLPT N2", "일본 비자 n2", "BJT", "일본어 능력시험", "고도인재 일본어", "jlpt 점수 계산"],
    datePublished: "2026-05-14",
    sections: [
      { title: "일본어 능력과 고도인재 포인트", summary: "고도인재 비자 포인트 제도에서 일본어 능력은 최대 15점을 획득할 수 있는 중요한 항목입니다. JLPT N1: 15점, N2: 10점, BJT 480+: 15점, BJT 400+: 10점." },
      { title: "JLPT N1 vs N2: 어떤 것을 목표로 해야 할까?", summary: "시간이 있다면 반드시 N1을 목표로 하세요. N2 대비 +5점이며, 취업 시장에서도 우대 조건입니다." },
      { title: "BJT(비즈니스 일본어능력시험)도 인정됩니다", summary: "BJT는 CBT 방식으로 거의 매일 응시 가능하며, 결과가 즉시 나옵니다. JLPT 시험일까지 기다리기 어렵다면 BJT를 먼저 응시하세요." },
      { title: "일본어 전공자 특별 조건", summary: "해외 대학에서 일본어를 전공하고 졸업한 경우, 별도의 시험 없이도 15점을 받을 수 있습니다." },
      { title: "효율적인 JLPT 준비 전략", summary: "N2 목표: 6~12개월, N1 목표: N2 합격 후 6~12개월. 일본 거주 중이라면 일상 생활 자체가 최고의 학습 환경입니다." },
    ],
    faq: [
      { q: "JLPT N2만으로도 고도인재 비자를 받을 수 있나요?", a: "네, 가능합니다. N2는 10점이며 다른 항목에서 60점 이상을 확보하면 됩니다. 다만 N1이면 5점 더 받을 수 있어 70점 달성이 훨씬 쉬워집니다." },
      { q: "JLPT와 BJT를 둘 다 가지고 있으면 점수가 합산되나요?", a: "아니요. 일본어 능력 항목에서 가장 높은 점수 하나만 인정됩니다." },
      { q: "JLPT 시험은 언제 볼 수 있나요?", a: "매년 7월과 12월 총 2회 실시됩니다. 한국에서는 약 3~4개월 전에 접수가 시작됩니다." },
    ],
  },
  {
    slug: "고도인재-비자-영주권-가이드",
    title: "고도인재 비자로 일본 영주권 받기: 1년·3년 최단 루트 완벽 가이드",
    description: "고도인재 비자를 통한 일본 영주권 취득 방법을 상세히 안내합니다. 70점·80점별 영주권 신청 시기, 필요 서류, 심사 기간, 주의사항까지.",
    keywords: ["일본 영주권", "고도인재 영주권", "일본 영주권 고도인재", "일본 영주권 취득", "고도인재 비자 영주권"],
    datePublished: "2026-05-14",
    sections: [
      { title: "고도인재 비자의 영주권 혜택", summary: "80점 이상: 1년 후 영주권 신청(9년 단축), 70점 이상: 3년 후(7년 단축), 일반 취업비자: 10년." },
      { title: "영주권 신청 조건", summary: "포인트 유지, 거주 기간, 세금·연금·보험 납부, 법규 준수, 경제적 안정, 신원 보증인이 필요합니다." },
      { title: "80점 최단 1년 루트 상세", summary: "입국 후 12개월에 신청 가능. 도쿄 기준 최근 심사 1년 6개월 이상 소요되어 총 약 2년 반~3년 예상. 지방 입관은 비교적 빠름." },
      { title: "영주권 신청 필요 서류", summary: "영주허가신청서, 포인트 계산표, 이유서, 과세·납세 증명서, 건강보험·연금 납부 증명 등이 필요합니다." },
      { title: "영주권 심사 기간과 결과", summary: "공식 안내는 약 4개월이나, 도쿄 기준 최근에는 1년 6개월 이상 소요되는 경우가 늘고 있습니다. 심사 중 이직, 추가 서류 요청, 장기 출국에 주의하세요." },
      { title: "영주권 취득 후 주의사항", summary: "재입국 허가, 7년마다 재류카드 갱신, 장기 해외 체류 시 취소 가능성에 주의." },
    ],
    faq: [
      { q: "영주권 신청 시점에서도 70점/80점 이상이어야 하나요?", a: "네. 고도인재 비자 취득 시점과 영주권 신청 시점 모두에서 해당 포인트를 충족해야 합니다." },
      { q: "이직하면 영주권 신청에 불리한가요?", a: "이직 자체가 불리하진 않지만, 14일 이내에 입관 신고가 필요하며 포인트 유지가 중요합니다." },
      { q: "가족도 영주권을 받을 수 있나요?", a: "배우자는 별도 신청이 필요합니다. 자녀는 일본 출생 시 출생신고와 함께 영주 자격 신청 가능합니다." },
    ],
  },
];
